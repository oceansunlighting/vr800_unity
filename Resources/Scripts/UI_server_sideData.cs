...
{
    public class UI_server_sideData
    {
        public static string JsonStr = "";
        public static string GetHTTP(int channelId,int limit, int page)
        {
            string MainPartId = "channelId=" + channelId;
            string MainPartLimit = "limit=" + 12;
            string MainPartPage = "page=" + page;
            string CurrentUrl = "http://api.vr800.com/vr/video/list?"+MainPartId+"&"+MainPartLimit+"&"+MainPartPage;
            ...
            byte[] dataBuffer = Encoding.UTF8.GetBytes(MainPartId+MainPartLimit+ MainPartPage);
        ...
        public static void SendData(int ChannelId,int limit,int page)
        {
            ...
            JsonStr = GetHTTP(ChannelId, limit,page);
